...
function setWorld(config, name){
	...
	execSync(`sed -i 's|${currentWorld}|${name}|gm' ${config.bot.serverPath}/server.properties`);
	execSync(`sed -i 's|${currentVersion}|${version}|gm' ${config.bot.serverPath}/server.properties`);
